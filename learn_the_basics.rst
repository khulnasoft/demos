...
.. grid:: 1 1 3 3
    ...
    .. grid-item-card:: Write Startai Code
        :link: learn_the_basics/01_write_startai_code.ipynb
    ...
    .. grid-item-card:: Trace Code
        ...
        Turn your Startai code into an efficient fully-functional graph, removing wrappers and unused parts of the code.
...
.. toctree::
    ...
    learn_the_basics/01_write_startai_code.ipynb
