youtube_map = {
    ...
    "demos/learn_the_basics/01_write_startai_code": "lYW_V4ZkYEo",
    ...
    "demos/examples_and_demos/image_segmentation_with_startai_unet": "ziqU1I8jYuU",
...
.. |Open in Colab| raw:: html
    ...
    <a href="https://colab.research.google.com/github/khulnasoft/demos/blob/main/{{ env.doc2path(env.docname, base=None)|replace("demos/", "", 1) }}" target="_blank">
        <img src="https://colab.research.google.com/assets/colab-badge.svg">
    </a>

.. |Github| raw:: html

    <a href="https://github.com/khulnasoft/demos/blob/main/{{ env.doc2path(env.docname, base=None)|replace("demos/", "", 1) }}" target="_blank">
